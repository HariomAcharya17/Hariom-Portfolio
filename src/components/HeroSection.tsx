...
<section
className="relative min-h-screen flex items-center justify-center overflow-hidden transition-all duration-700 ease-in-out bg-transparent"
>

{/* FLOATING LANYARD IN TOP RIGHT */}
<div className="absolute -top-4 right-2 md:-right-16 w-[480px] h-[720px] z-30 pointer-events-auto hidden md:block">
  <Lanyard position={[0, 0, 30]} gravity={[0, -30, 0]} lanyardWidth={10} />
</div>

<div className="container mx-auto px-6 relative z-10">

<div className="flex flex-col items-start justify-center text-left max-w-3xl ml-0 mr-auto">
